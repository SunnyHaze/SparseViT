...
import utils.sparsevit_transforms
...
def main(args):
    ...
    train_transform = utils.sparsevit_transforms.get_albu_transforms('train')
    test_transform = utils.sparsevit_transforms.get_albu_transforms('test')
    ...
    if os.path.isdir(args.test_data_path):
        ...
        dataset_test = utils.datasets.json_dataset(args.test_data_path,transform=test_transform)
